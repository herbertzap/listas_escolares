            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group">
                        <button class="btn btn-sm btn-outline-primary" onclick="verColegio('${colegio.nombre}', '${colegio.region}', '${colegio.comuna}')" title="Ver cursos del colegio">
                            <i class="fas fa-eye"></i> Ver Cursos
                        </button>
                        <button class="btn btn-sm btn-outline-success" onclick="agregarCurso('${colegio.nombre}', '${colegio.region}', '${colegio.comuna}')" title="Agregar nuevo curso">
...
function renderProductosModal(productos) {
    ...
    productos.forEach(producto => {
        ...
        const cantidadSeleccionada = productosSeleccionados.find(p => p.producto_shopify_id === producto.id)?.cantidad || 1;
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="${producto.id}" 
                               ...
                               onchange="toggleProductoSeleccionado(${producto.id}, '${producto.title}', ${producto.price})">
                    </div>
                </td>
                <td>
...
function toggleProductoSeleccionado(id, title, price) {
    ...
    // Recargar productos para mostrar/ocultar campos de cantidad
